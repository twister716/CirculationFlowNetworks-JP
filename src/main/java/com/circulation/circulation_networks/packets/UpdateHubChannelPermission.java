...
public final class UpdateHubChannelPermission implements Packet<UpdateHubChannelPermission> {
    ...
    public static final Type<UpdateHubChannelPermission> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":update_hub_channel_permission")
    );
    ...
    @Override
    public UpdateHubChannelPermission decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull UpdateHubChannelPermission message, @NonNull IPayloadContext context) {
