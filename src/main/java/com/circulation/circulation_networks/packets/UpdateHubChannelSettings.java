...
public final class UpdateHubChannelSettings implements Packet<UpdateHubChannelSettings> {
    ...
    public static final Type<UpdateHubChannelSettings> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":update_hub_channel_settings")
    );
    ...
    @Override
    public UpdateHubChannelSettings decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull UpdateHubChannelSettings message, @NonNull IPayloadContext context) {
