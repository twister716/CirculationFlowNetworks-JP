...
public class CirculationShielderSyncPacket implements Packet<CirculationShielderSyncPacket> {
    public static final Type<CirculationShielderSyncPacket> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":circulation_shielder_sync")
    );
    ...
    public CirculationShielderSyncPacket(BlockEntityCirculationShielder te) {
    ...
    @Override
    public CirculationShielderSyncPacket decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull CirculationShielderSyncPacket message, @NonNull IPayloadContext context) {
