...
public final class UpdatePlayerChargingMode implements Packet<UpdatePlayerChargingMode> {
    ...
    public static final Type<UpdatePlayerChargingMode> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":update_player_charging_mode")
    );
    ...
    @Override
    public UpdatePlayerChargingMode decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull UpdatePlayerChargingMode message, @NonNull IPayloadContext context) {
