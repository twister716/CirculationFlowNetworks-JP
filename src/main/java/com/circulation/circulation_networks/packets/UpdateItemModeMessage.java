...
public final class UpdateItemModeMessage implements Packet<UpdateItemModeMessage> {
    ...
    public static final Type<UpdateItemModeMessage> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":update_item_mode")
    );
    ...
    public UpdateItemModeMessage decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    public void handle(@NonNull UpdateItemModeMessage message, @NonNull IPayloadContext context) {
