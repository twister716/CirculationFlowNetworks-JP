...
public final class UpdateNodeCustomName implements Packet<UpdateNodeCustomName> {
    ...
    public static final Type<UpdateNodeCustomName> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":update_node_custom_name")
    );
    ...
    @Override
    public UpdateNodeCustomName decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull UpdateNodeCustomName message, @NonNull IPayloadContext context) {
