...
public final class NodeHudData implements Packet<NodeHudData> {
    ...
    public static final Type<NodeHudData> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":node_hud_data")
    );
    ...
    @Override
    public NodeHudData decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull NodeHudData message, @NonNull IPayloadContext context) {
