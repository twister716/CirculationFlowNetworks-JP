...
public final class BindHubChannel implements Packet<BindHubChannel> {
    ...
    public static final Type<BindHubChannel> TYPE = new Type<>(
        Identifier.parse(CirculationFlowNetworks.MOD_ID + ":bind_hub_channel")
    );
    ...
    @Override
    public BindHubChannel decode(@NonNull RegistryFriendlyByteBuf buf) {
    ...
    @Override
    public void handle(@NonNull BindHubChannel message, @NonNull IPayloadContext context) {
