...
public final class CFNConfig {
    ...
    private static final ModConfigSpec.DoubleValue EIT_ENERGY_SCOPE;
    private static final ModConfigSpec.DoubleValue EIT_LINK_SCOPE;
    private static final ModConfigSpec.DoubleValue EMIT_CHARGING_SCOPE;
    private static final ModConfigSpec.DoubleValue EMIT_LINK_SCOPE;
